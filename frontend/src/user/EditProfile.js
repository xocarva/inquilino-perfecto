...
function EditProfile() {
    ...
    const handleSubmit = async e => {
        ...
        if(firstName && (!isValidFirstName || firstName.length < 2 || firstName.length > 80)) setModal(<p>Tu nombre debe contener entre 2 y 80 carácteres.</p>)
        ...
        if(lastName && (!isValidLastName || lastName.length < 2 || lastName.length > 80)) setModal(<p>Tu apellido debe contener entre 2 y 80 carácteres.</p>)
        ...
        if(bio && (!isValidBio || bio.length < 10 || bio.length >= 200)) setModal(<p>Tu bio debe contener entre 10 y 200 carácteres.</p>)
