...
const { register, validate, rate, login, profile, getUserHouses, getRatings, editUserprofile, editProfile } = require('../controllers/users')
...
router.put('/:userId', isAuthorized, isActive, editProfile)
