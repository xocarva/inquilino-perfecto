...
const { createBooking, getAcceptedReceivedBookings, getPendingReceivedBookings, getPendingMadeBookings, getAcceptedMadeBookings, confirmBooking } = require('../controllers/bookings')
